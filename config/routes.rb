Rails.application.routes.draw do
  ...
  get  'nctu_cce_credit/editVAccount'  
  post 'nctu_cce_credit/updateVAccount'    
  post 'nctu_cce_credit/ackVAccount'    
